...
class MetalRenderer: NSObject, ObservableObject {
    ...
    func setupMTKView(_ mtkView: MTKView) {
        ...
        mtkView.colorPixelFormat = .bgra8Unorm_srgb // Enhanced color space for HDR-like quality
        mtkView.clearColor = MTLClearColor(red: 0, green: 0, blue: 0, alpha: 1)
        mtkView.framebufferOnly = false
        mtkView.preferredFramesPerSecond = 120 // Support for ProMotion displays
        mtkView.enableSetNeedsDisplay = false
        mtkView.isPaused = false
        mtkView.autoResizeDrawable = true
        
        // Enhanced performance settings for Metal rendering
    }
    ...
    func optimizeForLivePreview() {
        // Optimization for live preview - Metal automatically manages command buffer count
    }

...
class AdjustmentSet: ObservableObject, Codable {
    ...
    func combine(with other: AdjustmentSet) {
    ...
    var isEmpty: Bool {
        return exposure == 0.0 && highlights == 0.0 && shadows == 0.0 && contrast == 0.0 &&
               brightness == 0.0 && blackPoint == 0.0 && saturation == 0.0 && vibrancy == 0.0 &&
               temperature == 0.0 && tint == 0.0 && hue == 0.0 && sharpness == 0.0 &&
               definition == 0.0 && noiseReduction == 0.0 && vignette == 0.0 && grain == 0.0
    }
}